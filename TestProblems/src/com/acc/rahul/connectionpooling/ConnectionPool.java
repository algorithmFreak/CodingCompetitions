package com.acc.rahul.connectionpooling;
...
public class ConnectionPool {
	...
	public ConnectionPool(int maxPoolSize, int initialPoolSize, String url,
	...
	private synchronized void openAndPoolConnection() throws SQLException {
		...
		logger.log(Level.FINE,
				"Created connection {0}, currentPoolSize={1}, maxPoolSize={2}",
